    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mt-4 mb-1">Sign in to PoolRides</h1>
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm"><span className="px-2 bg-slate-950 text-slate-500">Admin Access</span></div>
            </div>
            ...
            <button 
              ...
              className="btn-secondary w-full text-slate-300 font-medium"
            >
              <Shield className="w-4 h-4 text-slate-500" /> Admin Login Portal
            </button>
            ...
            <button
              ...
              className="mt-2 w-full flex items-center justify-center gap-2 py-2.5 px-4 border border-slate-800 rounded-lg text-sm font-medium text-slate-300 bg-slate-900 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors shadow-sm"
            >
          ...
          <div className="mt-6 p-3 bg-teal-900/20 rounded-lg border border-teal-800/30">
            <p className="text-xs text-teal-400">
              <strong>Demo accounts:</strong> arjun@rvce.edu.in · priya@pes.edu (Standard passcode: <code className="text-teal-300">password123</code>)
            </p>
          </div>
        </div>
      </div>
