  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">All pools you've created or joined.</p>
      </div>
              ...
              <Link key={pool.id} to={`/pool/${pool.id}`}>
                <div className="card-hover">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex gap-2 items-center flex-wrap">
                        ...
                        {isCreator && (
                          <span className="text-xs px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200 font-medium">Creator</span>
                        )}
                      </div>
                      <p className="text-xs text-gray-500 mt-1">{collegeName}</p>
                    </div>
                    <span className="text-sm font-bold text-teal-700">₹{splitAmount}/person</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">{pool.originLabel}</p>
                      <p className="text-sm text-gray-500">{pool.destinationLabel}</p>
                    </div>
                  </div>
